...
# TODO: Reassign this to a useful real dir
...
# Create two environments: one for collecting data during training and one for evaluation
collect_env = GameEnv()
eval_env = GameEnv()
...
# In `Minitaur`, the reward function is based on how far the minitaur walks in 1000 steps and penalizes the energy expenditure.
