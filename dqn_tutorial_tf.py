...
example_environment = tf_py_environment.TFPyEnvironment(SimpleSimGym(STARTING_BUDGET, NUM_TARGETS, PLAYER_FOV, visualize=False))
...
reload.utils.show_training_graph(returns, num_iterations, "DQN Tutorial Model")
